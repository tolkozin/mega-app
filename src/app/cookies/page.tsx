  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-6 py-24">
        <h1 className="text-3xl font-heading font-extrabold text-[#1a1a2e] mb-2">Cookie Policy</h1>
        ...
        <div className="space-y-8 text-[#1a1a2e] text-[15px] leading-relaxed">
          ...
          <Section title="1. What Are Cookies?">
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1 text-[#6b7280]">
          ...
          <Section title="2. Types of Cookies We Use">
            <h4 className="text-[#1a1a2e] font-semibold mt-4 mb-2">2.1 Strictly Necessary Cookies</h4>
            <p>
            ...
            <p className="mt-2 text-[#6b7280] text-sm">Legal basis: Legitimate interest (necessary for service delivery). These do not require your consent.</p>

            <h4 className="text-[#1a1a2e] font-semibold mt-6 mb-2">2.2 Functional / Preference Cookies</h4>
            ...
            <p className="mt-2 text-[#6b7280] text-sm">Legal basis: Consent. You can disable these without losing core functionality.</p>

            <h4 className="text-[#1a1a2e] font-semibold mt-6 mb-2">2.3 Analytics Cookies</h4>
            <p>
            ...
            <p className="mt-2 text-[#6b7280] text-sm">Legal basis: Consent. You can opt out of analytics cookies without affecting your use of the Service.</p>

            <h4 className="text-[#1a1a2e] font-semibold mt-6 mb-2">2.4 Marketing / Advertising Cookies</h4>
            <p>
          ...
          <Section title="3. Cookie Duration">
            <ul className="list-disc pl-6 space-y-1 text-[#6b7280]">
              <li><strong className="text-[#1a1a2e]">Session cookies:</strong> deleted automatically when you close your browser.</li>
              <li><strong className="text-[#1a1a2e]">Authentication token:</strong> up to 30 days</li>
              <li><strong className="text-[#1a1a2e]">Preference cookies:</strong> up to 12 months</li>
              <li><strong className="text-[#1a1a2e]">Analytics cookies:</strong> up to 12 months</li>
            </ul>
          </Section>
          ...
          <Section title="4. Third-Party Cookies">
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1 text-[#6b7280]">
              <li><strong className="text-[#1a1a2e]">Lemon Squeezy</strong> &mdash; payment processing. Sets cookies to prevent fraud and remember payment state.</li>
              <li><strong className="text-[#1a1a2e]">PostHog</strong> &mdash; analytics.</li>
              <li><strong className="text-[#1a1a2e]">Vercel</strong> &mdash; hosting and performance.</li>
            </ul>
          ...
          <Section title="5. Your Cookie Choices and Rights">
            <h4 className="text-[#1a1a2e] font-semibold mt-4 mb-2">5.1 Cookie Preference Centre</h4>
            <p>
            ...
            <h4 className="text-[#1a1a2e] font-semibold mt-6 mb-2">5.2 Browser Controls</h4>
            <p>
            ...
            <h4 className="text-[#1a1a2e] font-semibold mt-6 mb-2">5.3 Do Not Track</h4>
            <p>
          ...
          <Section title="8. Contact Us">
            ...
            <p className="mt-2">
              Revenue Map<br />
              Email:{" "}
              <a href="mailto:privacy@revenuemap.app" className="text-[#2163e7] hover:underline">
                privacy@revenuemap.app
              </a>
              <br />
              Website:{" "}
              <Link href="/cookies" className="text-[#2163e7] hover:underline">
                revenuemap.app/cookies
              </Link>
            </p>
            <p className="mt-2 text-[#6b7280] text-sm">For GDPR-related requests, we aim to respond within 30 days.</p>
          </Section>

          <p className="text-[#6b7280] text-sm pt-4 border-t border-[#e5e7eb]">
