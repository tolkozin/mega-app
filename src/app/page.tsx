...
const plans = [
  {
    ...
    annualPrice: 23,
    annualTotal: 276,
    features: ["3 projects, 9 scenarios", "Share with up to 3 people", "30 AI messages per project", "10-day free trial"],
  ...
  },
  {
    ...
    annualPrice: 39,
    annualTotal: 468,
    features: ["Unlimited projects & scenarios", "Unlimited AI messages", "Share with up to 10 people", "10-day free trial"],
    highlighted: true,
    cta: "Start free trial",
    href: "/onboarding/survey",
  },
