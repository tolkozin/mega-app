        ...
        {!configHidden && (
          <div className="hidden md:block flex-shrink-0 relative">
            ...
            <button
              ...
              className="absolute top-1/2 -translate-y-1/2 right-2 translate-x-full z-10 w-5 h-10 bg-[#ECECF2] hover:bg-[#DDE0E9] rounded-r-lg flex items-center justify-center text-[#8181A5] hover:text-[#1C1D21] transition-colors"
