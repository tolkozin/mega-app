...
export default function ModelDashboardError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="text-xl font-bold text-[#1C1D21] mb-2">Failed to load model</h2>
        <p className="text-sm text-[#8181A5] mb-6">
          There was a problem loading your financial model. Please try again.
        </p>
