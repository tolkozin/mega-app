...
export default function EcommerceDashboardPage() {
  ...
  useEffect(() => {
    ...
    const keys = ["Month", "Gross Revenue", "Net Revenue", "Net Profit", "EBITDA", "New Customers", "Returning Customers", "Total Orders", "AOV", "CAC", "LTV", "LTV/CAC", "Gross Margin %", "ROI %", "Cash Balance", "Cumulative Net Profit", "Ad Spend", "ROAS"];
  ...
  return (
    <AppShell title="E-commerce Dashboard" monthRange={monthRange} onMonthRangeChange={setMonthRange} totalMonths={totalMonths}>
      <div className="flex flex-col md:flex-row h-[calc(100vh-3.5rem)]">
        {!configHidden && <EcomSidebar projectId={project?.id ?? null} onProjectCreated={setProjectId} />}
