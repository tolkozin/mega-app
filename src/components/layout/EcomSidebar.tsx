...
export function EcomSidebar({ projectId, onProjectCreated, monthRange, productType }: {
  ...
  const content = (
    <div className="relative p-2 space-y-2">
      ...
      <div className="rounded-2xl bg-white border border-[#eef0f6] px-4 py-3 shadow-[0_1px_4px_rgba(0,0,0,0.04)]">
        <h2 className="font-extrabold text-sm text-[#1a1a2e] font-[Lato,sans-serif]">E-commerce Model Config</h2>
      </div>
  ...
  return (
    <aside className="w-[360px] bg-[#eef0f6] overflow-y-auto h-[calc(100dvh-3.5rem-1rem)] flex-shrink-0 mx-2 mb-2 rounded-2xl" data-tour="config-sidebar">
      {content}
    </aside>
  );
}
