...
export function SaasCharts({ results, p1End, p2End }: ChartsProps) {
  ...
  return (
    <div className="space-y-2">
      {/* ── ARR & Growth ── */}
      <h3 className="text-base font-bold text-[#1C1D21] mt-8 mb-3">ARR &amp; Growth</h3>
      ...
      {/* ── Efficiency & P&L ── */}
      <h3 className="text-base font-bold text-[#1C1D21] mt-8 mb-3">Efficiency &amp; P&amp;L</h3>
      ...
      {/* ── Pipeline & Retention ── */}
      <h3 className="text-base font-bold text-[#1C1D21] mt-8 mb-3">Pipeline &amp; Retention</h3>
