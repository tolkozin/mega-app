...
<MetricCalculator
  ...
  fields={[
    { name: "customersStart", label: "Customers at Start of Month", defaultValue: 320, min: 1, step: 1 },
    { name: "customersLost", label: "Customers Lost This Month", defaultValue: 11, min: 0, step: 1 },
  ]}
  result={{ label: "Monthly Churn Rate", suffix: "%" }}
  formula={(v) => (v.customersLost / v.customersStart) * 100}
/>
