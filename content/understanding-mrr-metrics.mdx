...
<MetricCalculator
  ...
  fields='[{"name":"subscribers","label":"Active Subscribers","defaultValue":150,"min":1,"step":1},{"name":"arpa","label":"Average Revenue Per Account (ARPA)","defaultValue":99,"min":0,"prefix":"$","step":1}]'
